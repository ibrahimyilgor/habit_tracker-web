          ...
          <Stack spacing={3}>
            ...
            {!openAdd && (
              <>
                <TicketsTable
                  count={0}
                  items={[{name: "ticket1", category: "category1", description: "description1", status: "ACTIVE"},{name: "ticket2", category: "category2", description: "description2", status: "DONE"},{name: "ticket3", category: "category3", description: "description3", status: "CANCELLED"}]}
